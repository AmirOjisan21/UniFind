...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased z-0" style="background-image: ">
        ...
        <div class="pl-20">
            <a href="{{ route('events') }}"class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300"> Back
            ...
            function initMap() {
                ...
                navigator.geolocation.getCurrentPosition(
                    function (position) {
                        ...
                        const destLatLng = L.latLng(event.latitude, event.longitude)
