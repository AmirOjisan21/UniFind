...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased z-0" style="background-image: ">
        <div class="flex justify-center py-10 px-10">
            <div id="map" class="h-96 w-5/6 rounded-md z-0"></div>
        </div>
        <div class="pl-20">
            <a href="{{ route('ksajs') }}"class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300"> Back
            ...
            function initMap() {
                ...
                navigator.geolocation.getCurrentPosition(
                    function (position) {
                        ...
                        const destLatLng = L.latLng(ksajs.latitude, ksajs.longitude)
