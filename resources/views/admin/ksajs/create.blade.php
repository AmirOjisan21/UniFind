            ...
            <div class="flex justify-center">
              <div class="w-full md:w-6/12">
                <div class="bg-white shadow-md rounded-lg">
                  ...
                  <form method="POST" action="{{ route('ksajs.store') }}" enctype="multipart/form-data" accept-charset="UTF-8" class="px-4 py-4">
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="flex justify-between mt-4">
                      ...
                      <a href="{{ route('ksajs.index') }}" class="px-4 py-2 bg-gray-300 text-gray-700 rounded hover:bg-gray-400 cursor-pointer">{{ __('cancel') }}</a>
                    </div>
                  </form>
                </div>
              </div>
