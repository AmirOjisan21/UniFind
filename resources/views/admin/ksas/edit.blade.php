                        ...
                        <div class="w-full md:w-1/2">
                            @if (request('action') == 'delete' && $ksas)
                                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                                    <div class="mb-4">
                                        ...
                                        <div class="mt-4">
                                            @if ($ksas->image)
                                                <img src="{{ asset('/images/' . $ksas->image) }}"
                                                    alt="{{ $ksas->name }}" class="w-full mb-3">
                                            @else
                            ...
                            @else
                                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                                    ...
                                    <form method="POST" action="{{ route('ksas.update', $ksas) }}"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input id="name" type="text"
                                                ...
                                                name="name" value="{{ old('name', $ksas->name) }}" required>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea id="description"
                                                ...
                                                name="description" rows="4">{{ old('description', $ksas->description) }}</textarea>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea id="open_hours"
                                                ...
                                                name="open_hours" rows="4">{{ old('open_hours', $ksas->open_hours) }}</textarea>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea id="important_details"
                                                ...
                                                name="important_details" rows="4">{{ old('important_details', $ksas->important_details) }}</textarea>
                                            ...
                                            <div class="flex">
                                                <div class="w-1/2 pr-3">
                                                    ...
                                                    <input id="longitude" type="text"
                                                        ...
                                                        name="longitude"
                                                        value="{{ old('longitude', $ksas->longitude) }}" required>
                                                ...
                                                <div class="w-1/2 pl-3">
                                                    ...
                                                    <input id="latitude" type="text"
                                                        ...
                                                        name="latitude"
                                                        value="{{ old('latitude', $ksas->latitude) }}" required>
                                ...
                                <div class="mb-4">
                                    ...
                                    <a href="{{ route('ksas.show', $ksas) }}"
                                        class="text-blue-500 hover:text-blue-700">{{ __('Cancel') }}</a>
                                    <a href="{{ route('ksas.edit', [$ksas, 'action' => 'delete']) }}"
                                        id="del-ksas-{{ $ksas->id }}"
